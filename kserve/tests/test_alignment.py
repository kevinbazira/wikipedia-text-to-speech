...
def test_assign_frames_single_word():
    ...
    result = _assign_frames_to_words(segments, alignment, words, clean_words, total_frames=10)
...
def test_assign_frames_two_words():
    ...
    result = _assign_frames_to_words(segments, alignment, words, clean_words, total_frames=20)

    assert result[0] == {"word": "Hi", "start_ms": 0, "end_ms": 10 * FRAME_DURATION_MS}
    assert result[1] == {"word": "Yo", "start_ms": 10 * FRAME_DURATION_MS, "end_ms": 20 * FRAME_DURATION_MS}
...
def test_assign_frames_preserves_original_word_casing_and_punctuation():
    ...
    result = _assign_frames_to_words(segments, alignment, words, clean_words, total_frames=15)
